...
// â”€â”€â”€ Validar token â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
if ($token !== '') {
...
// â”€â”€â”€ Procesar nueva contraseÃ±a â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
if ($_SERVER['REQUEST_METHOD'] === 'POST' && $valid) {
    ...
    if (strlen($nueva) < 8) {
        ...
        $mensaje = 'Â¡ContraseÃ±a actualizada! Ahora puedes iniciar sesiÃ³n.';
        $tipo    = 'ok';
...
<head>
  ...
  <title>Nueva ContraseÃ±a - LF Carpinter</title>
  ...
  <main class="px-6 py-16 flex-grow flex items-center justify-center">
    <div class="w-full max-w-md">
      ...
      <div class="mb-6 px-5 py-4 rounded-xl text-center font-medium <?php echo $tipo === 'ok' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-red-100 text-red-800 border border-red-300'; ?>">
        ...
        <?php if ($tipo === 'ok'): ?>
          <br><a href="iniciar-sesion.php" class="underline font-bold mt-2 inline-block">Ir al inicio de sesiÃ³n</a>
        <?php endif; ?>
      </div>
      <?php endif; ?>
      ...
      <?php if (!$valid && $tipo !== 'ok'): ?>
        ...
        <div class="bg-white p-10 rounded-2xl shadow-xl text-center border border-stone-200">
          ...
          <h2 class="text-2xl font-bold text-stone-800 mb-2">Enlace invÃ¡lido o expirado</h2>
          <p class="text-stone-500 mb-6">Este enlace ya expirÃ³ o no es vÃ¡lido. Solicita uno nuevo.</p>
      ...
      <?php elseif ($valid): ?>
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-3xl font-extrabold text-gray-800 mb-2">Nueva ContraseÃ±a</h2>
          <p class="text-gray-600">Elige una contraseÃ±a segura de al menos 8 caracteres</p>
        </div>
        ...
        <div class="bg-white p-8 rounded-xl shadow-lg border border-amber-100">
          <form method="POST" action="reset_password.php?token=<?php echo htmlspecialchars($token); ?>" class="space-y-5">
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Nueva contraseÃ±a</label>
            ...
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-2">Confirmar contraseÃ±a</label>
            ...
            <button type="submit"
              ...
              <i class="fas fa-check"></i> Guardar nueva contraseÃ±a
            </button>
          </form>
        </div>
      <?php endif; ?>
