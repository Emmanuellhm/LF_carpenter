...
// Determinar el enlace del panel segÃºn el rol
$panelLink = '';
$panelText = 'Mi Panel';
if ($isLoggedIn) {
    switch ($userRole) {
    ...
    <div class="flex justify-between items-center md:grid md:grid-cols-3">
      ...
      <div class="hidden md:flex justify-center justify-self-center">
        <div class="flex space-x-8">
          <a href="index.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'index.php') ? 'text-amber-700 font-medium' : 'text-gray-600 hover:text-amber-700'; ?> transition">PÃ¡gina de inicio</a>
          <a href="contactanos.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'contactanos.php') ? 'text-amber-700 font-medium' : 'text-gray-600 hover:text-amber-700'; ?> transition">ContÃ¡ctanos</a>
      ...
      <div class="flex items-center justify-self-end gap-3">
        ...
        <?php else: ?>
          <!-- Usuario sin sesiÃ³n -->
          <a href="iniciar-sesion.php" class="text-gray-600 hover:text-amber-700 transition font-medium">
            Iniciar sesiÃ³n
          </a>
