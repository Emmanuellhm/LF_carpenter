...
urlpatterns = [
    ...
    path('registro/exitoso/', views.registro_exitoso_usuario, name='registro_exitoso_usuario'),
    path('registro/google-exitoso/', views.registro_exitoso_google, name='registro_exitoso_google'),
