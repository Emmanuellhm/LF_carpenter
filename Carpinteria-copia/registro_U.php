      ...
      <form id="registroUsuario" action="register_user.php" method="post" class="space-y-6">
        ...
        <div class="step" id="step-1">
          ...
          <div>
            ...
            <input type="text" id="nombre" name="nombre" required oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ\s]/g, '')"
        ...
        <div class="step hidden" id="step-2">
          ...
          <div>
            ...
            <input type="text" id="ciudad" name="ciudad" required oninput="this.value = this.value.replace(/[^a-zA-ZáéíóúÁÉÍÓÚñÑ\s]/g, '')"
              class="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500">
          </div>
