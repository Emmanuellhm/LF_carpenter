  ...
  <aside class="w-64 bg-white shadow-xl flex flex-col justify-between border-r border-stone-200">
    <div>
      ...
      <nav class="flex flex-col space-y-2 px-6 mt-6">
        ...
        <button onclick="mostrarSeccion('cambiar-password')" class="text-stone-700 hover:bg-amber-100 rounded-lg px-4 py-2 font-medium text-left">Cambiar Contraseña</button>
