...
if ($isLoggedIn) {
    switch ($userRole) {
        case 'admin':
            $panelLink = 'admin/admin.php';
            $panelText = 'Panel Admin';
            break;
        case 'carpenter':
            $panelLink = 'carpintero/panel_carpintero.php';
            $panelText = 'Mi Panel';
            break;
        case 'user':
            $panelLink = 'usuario/panel_usuario.php';
            $panelText = 'Mi Panel';
            break;
    }
}
    ...
    <div class="flex justify-between items-center md:grid md:grid-cols-3">
      ...
      <div class="hidden md:flex justify-center justify-self-center">
        <div class="flex space-x-8">
          ...
          <a href="usuario/ver_carpinteros.php" class="<?php echo (basename($_SERVER['PHP_SELF']) == 'ver_carpinteros.php') ? 'text-amber-700 font-medium' : 'text-gray-600 hover:text-amber-700'; ?> transition">Ver Carpinteros</a>
          <?php endif; ?>
        </div>
      </div>
      ...
      <div class="flex items-center justify-self-end gap-3">
        <?php if ($isLoggedIn): ?>
          ...
          <div class="flex items-center gap-3">
            ...
            <a href="auth/logout.php" class="text-gray-600 hover:text-red-600 transition font-medium">
              <i class="fas fa-sign-out-alt"></i> Cerrar sesión
            </a>
          </div>
        <?php else: ?>
          <!-- Usuario sin sesión -->
          <a href="auth/iniciar-seccion.php" class="text-gray-600 hover:text-amber-700 transition font-medium">
            Iniciar sesión
          </a>
          ...
          <div class="relative" id="dropdown-registrar">
            ...
            <div id="dropdown-menu" 
              ...
              <a href="auth/registro_C.php" 
                ...
                <img src="assets/img/herramienta-de-martillo.png" class="w-5 h-5">
