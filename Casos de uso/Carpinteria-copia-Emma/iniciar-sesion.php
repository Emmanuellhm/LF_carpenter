...
// Para leer parÃ¡metros como ?error o ?pendiente=1
...
<body class="bg-gradient-to-br from-amber-50 to-stone-100 text-stone-800 font-sans">
  ...
  <!-- ðŸ”¥ MODAL ERROR (Credenciales invÃ¡lidas / Bloqueado / Rate Limit) -->
  <?php if ($error_code > 0): ?>
  <div id="modalError"
    ...
    <div class="bg-white px-8 py-6 rounded-2xl shadow-xl max-w-sm text-center">
      <p class="text-red-600 text-xl font-bold mb-3">
        <?php
          if ($error_code == 2) echo 'ðŸ”’ Cuenta bloqueada';
          elseif ($error_code == 3) echo 'â³ Demasiados intentos';
          else echo 'âŒ Error de inicio de sesiÃ³n';
        ?>
      </p>
      <p class="text-stone-700 mb-6">
        <?php
          if ($error_code == 2) {
            ...
            echo 'Credenciales incorrectas. Verifica tu correo y contraseÃ±a.';
          }
        ?>
      </p>
