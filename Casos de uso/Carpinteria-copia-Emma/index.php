...
<head>
  ...
  <title>LF Carpinter | CarpinterÃ­a de Calidad</title>
...
<section class="relative bg-gradient-to-r from-amber-900 to-amber-700 text-white">
  <div class="container mx-auto px-6 py-16 flex flex-col md:flex-row md:gap-12 items-center">
    <div class="md:w-1/2 mb-10 md:mb-0">
      <small class="uppercase text-amber-300 font-semibold tracking-wide">DiseÃ±o y funcionalidad a tu medida</small>
      <h1 class="text-4xl md:text-5xl font-bold mt-3 mb-4">CarpinterÃ­a de calidad para tu hogar y negocio</h1>
      <p class="text-xl mb-8 text-amber-100">
        Descubre la precisiÃ³n y el detalle en cada proyecto. En <span class="font-bold text-amber-300">LF Carpinter</span>,
      ...
      <div class="flex flex-wrap gap-4 mb-8">
        <span class="bg-amber-800 text-amber-100 px-4 py-2 rounded-lg shadow-sm flex items-center">
          <i class="fas fa-tools mr-2"></i> AtenciÃ³n personalizada
        </span>
        <span class="bg-amber-800 text-amber-100 px-4 py-2 rounded-lg shadow-sm flex items-center">
          <i class="fas fa-check-circle mr-2"></i> GarantÃ­a de calidad
        </span>
        <span class="bg-amber-800 text-amber-100 px-4 py-2 rounded-lg shadow-sm flex items-center">
      ...
      <div class="flex flex-col sm:flex-row gap-6 mt-8">
        ...
        <div class="bg-amber-800 p-6 rounded-xl shadow-lg border border-amber-700 w-full sm:w-64 hover:shadow-xl transition">
          ...
          <p class="text-amber-100 text-sm mb-3">Ãšnete a nuestra red de profesionales mediante una solicitud de ingreso.</p>
    ...
    <div class="md:w-1/2 md:pl-12">
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="bg-amber-800 rounded-2xl p-2 shadow-2xl transform -rotate-1 mt-8">
          <img src="./img/Sin tÃ­tulo.jpeg" alt="Imagen 2" class="rounded-xl shadow-lg h-56 w-full object-cover">
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <div class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition group">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">DiseÃ±o ergonÃ³mico con madera de roble y acabados profesionales.</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition group">
        <div class="overflow-hidden">
          <img src="img/estanteria.webp" alt="EstanterÃ­a Minimalista" class="w-full h-48 object-cover group-hover:scale-110 transition duration-500">
        </div>
        <div class="p-6">
          <h3 class="text-xl font-bold text-gray-800 mb-2">EstanterÃ­a Minimalista</h3>
          <p class="text-gray-600">Estilo moderno, ideal para espacios pequeÃ±os. Hecha en pino tratado.</p>
        </div>
      </div>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition group">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">DiseÃ±o clÃ¡sico, barnizada a mano. Ideal para dormitorios.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="py-20 bg-amber-100">
  <div class="container mx-auto px-6">
    <div class="text-center mb-16">
      ...
      <p class="text-gray-600 max-w-2xl mx-auto">Profesionales dedicados a crear muebles Ãºnicos con pasiÃ³n y experiencia</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div onclick="window.location.href='cliente2.php'" class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition cursor-pointer group">
        <div class="overflow-hidden">
          <img src="img/fotoP.jpg" alt="Juan PÃ©rez" class="w-full h-48 object-cover group-hover:scale-110 transition duration-500">
        </div>
        <div class="p-6">
          <h3 class="text-xl font-bold text-gray-800 mb-2">Juan PÃ©rez</h3>
          <p class="text-gray-600">Especialista en muebles a medida con 10 aÃ±os de experiencia.</p>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition cursor-pointer group">
        <div class="overflow-hidden">
          <img src="img/fotoP.jpg" alt="Laura GÃ³mez" class="w-full h-48 object-cover group-hover:scale-110 transition duration-500">
        </div>
        <div class="p-6">
          <h3 class="text-xl font-bold text-gray-800 mb-2">Laura GÃ³mez</h3>
          <p class="text-gray-600">Experta en restauraciÃ³n de muebles antiguos, atenciÃ³n personalizada.</p>
          <div class="mt-4 flex items-center text-amber-600">
            <span>Ver perfil</span>
            <i class="fas fa-arrow-right ml-2"></i>
          </div>
      ...
      <div class="bg-white rounded-xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition cursor-pointer group">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600">DiseÃ±o moderno y funcional. Proyectos innovadores y a buen precio.</p>
          <div class="mt-4 flex items-center text-amber-600">
            <span>Ver perfil</span>
            <i class="fas fa-arrow-right ml-2"></i>
          </div>
