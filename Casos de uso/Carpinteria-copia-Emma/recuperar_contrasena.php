...
// â”€â”€â”€ Procesamiento del formulario â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['email'])) {
    ...
    // Buscar en carpenters si no se encontrÃ³
    if (!$found) {
    ...
    if (!$found) {
        ...
        $mensaje = 'Si ese correo estÃ¡ registrado, recibirÃ¡s el enlace en breve.';
        $tipo    = 'ok';
    } else {
        ...
        try {
            ...
            $mail->setFrom('soporte.lfcarpinter@gmail.com', 'LF CarpinterÃ­a');
            $mail->addAddress($email);
            $mail->Subject = 'Recupera tu contraseÃ±a - LF CarpinterÃ­a';
            $mail->isHTML(true);
            $mail->Body = "
                <div style='font-family:Arial,sans-serif;max-width:500px;margin:auto'>
                  <div style='background:#92400e;padding:24px;border-radius:12px 12px 0 0;text-align:center'>
                    <h1 style='color:#fff;margin:0;font-size:22px'>LF CarpinterÃ­a</h1>
                  </div>
                  <div style='background:#fff;padding:32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 12px 12px'>
                    <h2 style='color:#1c1917'>Restablecer contraseÃ±a</h2>
                    <p style='color:#57534e'>Hemos recibido una solicitud para restablecer la contraseÃ±a de tu cuenta. Haz clic en el botÃ³n de abajo para crear una nueva contraseÃ±a:</p>
                    ...
                    <p style='color:#78716c;font-size:13px'>Este enlace expirarÃ¡ en <strong>30 minutos</strong>. Si no solicitaste esto, ignora este mensaje.</p>
                    <hr style='border:none;border-top:1px solid #e5e7eb;margin:24px 0'>
                    <p style='color:#a8a29e;font-size:12px;text-align:center'>Â© 2025 LF CarpinterÃ­a. Todos los derechos reservados.</p>
                  </div>
                </div>";
            ...
            $mensaje = 'No se pudo enviar el correo. Por favor intenta mÃ¡s tarde.';
            $tipo    = 'error';
        }
    }
}
  ...
  <main class="px-6 md:px-20 py-16 flex-grow">
    <div class="max-w-md mx-auto">
      ...
      <div class="mb-6 px-5 py-4 rounded-xl text-center font-medium <?php echo $tipo === 'ok' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-red-100 text-red-800 border border-red-300'; ?>">
        <?php echo $tipo === 'ok' ? 'âœ…' : 'âŒ'; ?> <?php echo $mensaje; ?>
      </div>
      <?php endif; ?>
      ...
      <div class="mt-8 bg-gradient-to-br from-amber-900 to-amber-700 text-white rounded-lg p-6 shadow-lg">
        ...
        <ul class="text-sm text-amber-100 space-y-2">
          ...
          <li class="flex items-start gap-3"><span class="font-bold text-amber-300">2.</span><span>Te llegarÃ¡ un correo con un enlace seguro</span></li>
          ...
          <li class="flex items-start gap-3"><span class="font-bold text-amber-300">4.</span><span>Haz clic en el enlace y crea tu nueva contraseÃ±a</span></li>
        </ul>
      </div>
