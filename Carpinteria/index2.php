...
<header class="flex justify-between items-center px-8 h-20 bg-white shadow-md border-b border-stone-200">
  ...
  <div class="flex items-center">
    <img src="./img/Logo de Carpintería LF.png" alt="LF Logo" class="h-20 w-20">
  </div>
  
  <!-- Menú alineado -->
  <nav class="flex gap-8 items-center">
    <a href="index.php" class="font-medium text-stone-700 hover:text-amber-600">Página de inicio</a>
    <a href="contactanos.html" class="font-medium text-stone-700 hover:text-amber-600">Contáctanos</a>
    <a href="iniciar-seccion.php" class="font-semibold text-white bg-amber-600 hover:bg-amber-700 px-5 py-2 rounded-lg shadow">Iniciar sesión</a>
  </nav>
</header>
...
<section class="flex flex-col md:flex-row items-start justify-between px-8 pt-16 pb-8 gap-10">
  ...
  <div class="max-w-xl flex flex-col">
    <small class="uppercase text-amber-600 font-semibold tracking-wide">Diseño y funcionalidad a tu medida</small>
    <h1 class="text-4xl font-extrabold mt-3 mb-4 text-stone-800">Carpintería de calidad para tu hogar y negocio</h1>
    <p class="text-stone-600 leading-relaxed mb-6">
      Descubre la precisión y el detalle en cada proyecto. En <span class="font-bold text-amber-700">LF Carpinter</span>,
      transformamos tus ideas en realidad con madera de primera.
    </p>
    <div class="flex flex-wrap gap-4 text-sm font-medium mb-10">
      <span class="bg-amber-100 text-amber-700 px-3 py-2 rounded-lg shadow-sm">🔧 Atención personalizada</span>
      <span class="bg-amber-100 text-amber-700 px-3 py-2 rounded-lg shadow-sm">✅ Garantía de calidad</span>
      <span class="bg-amber-100 text-amber-700 px-3 py-2 rounded-lg shadow-sm">📍 Servicio local</span>
    </div>
    ...
    <div class="flex flex-col sm:flex-row gap-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 w-full sm:w-64 hover:shadow-xl transition">
        ...
        <p class="text-stone-600 text-sm mb-3">Únete a nuestra red de profesionales mediante una solicitud de ingreso.</p>
        <a href="registro_C.php" class="text-amber-600 font-semibold hover:underline">Enviar solicitud →</a>
      </div>
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 w-full sm:w-64 hover:shadow-xl transition">
        ...
        <a href="registro_U.php" class="text-amber-600 font-semibold hover:underline">Buscar servicios →</a>
      </div>
    </div>
  </div>
  ...
  <div class="grid grid-cols-2 gap-4 self-start">
    ...
    <img src="./img/Sin título.jpeg" alt="Imagen 2" class="rounded-xl shadow-md h-56 w-full object-cover">
  ...
  <div class="flex gap-6 overflow-x-auto pb-4">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-stone-200 w-80 flex-shrink-0 hover:shadow-xl transition">
      ...
      <div class="p-4">
        ...
        <p class="text-sm text-stone-600 mt-2">Diseño ergonómico con madera de roble y acabados profesionales.</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-stone-200 w-80 flex-shrink-0 hover:shadow-xl transition">
      ...
      <div class="p-4">
        <h3 class="text-lg font-bold text-stone-800">Estantería Minimalista</h3>
        <p class="text-sm text-stone-600 mt-2">Estilo moderno, ideal para espacios pequeños. Hecha en pino tratado.</p>
      </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-stone-200 w-80 flex-shrink-0 hover:shadow-xl transition">
      ...
      <div class="p-4">
        ...
        <p class="text-sm text-stone-600 mt-2">Diseño clásico, barnizada a mano. Ideal para dormitorios.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="px-10 py-16">
  ...
  <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
    <div onclick="window.location.href='cliente2.html'"
      ...
      <h3 class="text-lg font-bold text-stone-800">Juan Pérez</h3>
      <p class="text-sm text-stone-600 mt-2">Especialista en muebles a medida con 10 años de experiencia.</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 hover:shadow-xl transition cursor-pointer">
      <img src="img/fotoP.jpg" alt="Carpintero 2"
        class="h-40 w-full object-cover rounded-lg mb-4 shadow">
      <h3 class="text-lg font-bold text-stone-800">Laura Gómez</h3>
      <p class="text-sm text-stone-600 mt-2">Experta en restauración de muebles antiguos, atención personalizada.</p>
    </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 hover:shadow-xl transition cursor-pointer">
      ...
      <p class="text-sm text-stone-600 mt-2">Diseño moderno y funcional. Proyectos innovadores y a buen precio.</p>
    </div>
