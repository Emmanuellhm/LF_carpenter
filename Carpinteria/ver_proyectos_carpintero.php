...
// Obtener información del carpintero
...
<head>
  ...
  <title>Proyectos de <?php echo htmlspecialchars($carpenter['carpenter_name']); ?> - LF Carpintería</title>
  ...
  <main class="max-w-7xl mx-auto px-8 py-12">
      ...
      <div class="flex items-center gap-6">
        ...
        <div class="flex-1">
          ...
          <div class="flex gap-4 text-stone-600">
            ...
            <span><strong>Experiencia:</strong> <?php echo htmlspecialchars($carpenter['experience_years']); ?> años</span>
    ...
    <?php if (empty($projects)): ?>
      <div class="bg-white p-12 rounded-xl shadow border border-stone-200 text-center">
        <p class="text-stone-500 text-lg">Este carpintero aún no ha publicado proyectos.</p>
      </div>
    <?php else: ?>
      <!-- Grid de Proyectos -->
