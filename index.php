    ...
    <div class="md:w-1/2 mb-10 md:mb-0">
      ...
      <div class="flex flex-col sm:flex-row gap-6 mt-8">
        ...
        <div class="bg-amber-800 p-6 rounded-xl shadow-lg border border-amber-700 w-full sm:w-64 hover:shadow-xl transition">
          ...
          <a href="auth/registro_C.php" class="text-amber-300 font-semibold hover:underline flex items-center">
        ...
        <div class="bg-amber-800 p-6 rounded-xl shadow-lg border border-amber-700 w-full sm:w-64 hover:shadow-xl transition">
          ...
          <a href="auth/registro_U.php" class="text-amber-300 font-semibold hover:underline flex items-center">
    ...
    <div class="md:w-1/2 md:pl-12">
      <div class="grid grid-cols-2 gap-4">
        <div class="bg-amber-800 rounded-2xl p-2 shadow-2xl transform rotate-1">
          <img src="assets/img/imagen1.jpeg" alt="Imagen 1" class="rounded-xl shadow-lg h-56 w-full object-cover">
        </div>
        <div class="bg-amber-800 rounded-2xl p-2 shadow-2xl transform -rotate-1 mt-8">
          <img src="assets/img/Sin título.jpeg" alt="Imagen 2" class="rounded-xl shadow-lg h-56 w-full object-cover">
        </div>
        <div class="bg-amber-800 rounded-2xl p-2 shadow-2xl transform -rotate-2">
          <img src="assets/img/imagen2.jpeg" alt="Imagen 3" class="rounded-xl shadow-lg h-56 w-full object-cover">
        </div>
        <div class="bg-amber-800 rounded-2xl p-2 shadow-2xl transform rotate-2 mt-8">
          <img src="assets/img/imagen3.jpeg" alt="Imagen 4" class="rounded-xl shadow-lg h-56 w-full object-cover">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div>
        <div class="flex items-center mb-4">
          <img src="assets/img/Logo de Carpintería LF.png" alt="LF Logo" class="h-16 w-16">
        </div>
      ...
      <div>
        ...
        <ul class="space-y-1 text-sm">
          ...
          <li><a href="auth/iniciar-seccion.php" class="hover:text-amber-400 transition">Iniciar sesión</a></li>
        </ul>
      </div>
