...
<main class="p-10 space-y-10">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 hover:shadow-xl transition">
        <div class="flex items-center gap-4 mb-4">
          ...
          <h2 class="text-xl font-bold text-stone-800">Subir Proyectos</h2>
        </div>
        <p class="text-stone-600 mb-4">Publica tus trabajos y muestra tu portafolio.</p>
        <button onclick="mostrarSeccion('proyectos')" class="inline-block bg-amber-600 hover:bg-amber-700 text-white font-semibold px-6 py-3 rounded-lg shadow w-full text-center">
          Gestionar Proyectos
        </button>
      </div>
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 hover:shadow-xl transition">
        ...
        <p class="text-stone-600 mb-4">Revisa proyectos personalizados de clientes.</p>
      ...
      <div class="bg-white p-6 rounded-xl shadow-lg border border-stone-200 hover:shadow-xl transition">
        ...
        <p class="text-stone-600 mb-4">Edita tu perfil y datos de contacto.</p>
        <button onclick="mostrarSeccion('info')" class="inline-block bg-stone-600 hover:bg-stone-700 text-white font-semibold px-6 py-3 rounded-lg shadow w-full text-center">
          Ver Perfil
        </button>
      </div>
    </div>
    ...
    <div class="mt-10 grid md:grid-cols-3 gap-6">
      <div class="bg-gradient-to-br from-stone-600 to-stone-700 p-6 rounded-xl shadow-lg text-white">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-stone-200 text-sm font-medium mb-1">Proyectos Publicados</p>
            <p class="text-4xl font-bold"><?php echo count($projects); ?></p>
          </div>
      ...
      <div class="bg-gradient-to-br from-amber-500 to-amber-600 p-6 rounded-xl shadow-lg text-white">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-amber-100 text-sm font-medium mb-1">Solicitudes Activas</p>
            <p class="text-4xl font-bold"><?php echo count(array_filter($project_requests, fn($r) => $r['status'] === 'pending')); ?></p>
          </div>
          <div class="bg-white/20 p-3 rounded-lg">
      ...
      <div class="bg-gradient-to-br from-orange-600 to-orange-700 p-6 rounded-xl shadow-lg text-white">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-orange-100 text-sm font-medium mb-1">Proyectos Completados</p>
            <p class="text-4xl font-bold"><?php echo count(array_filter($project_requests, fn($r) => $r['status'] === 'completed')); ?></p>
          </div>
          <div class="bg-white/20 p-3 rounded-lg">
    ...
    <div class="mt-10 bg-white p-8 rounded-xl shadow-lg border border-stone-200">
      ...
      <div class="grid md:grid-cols-2 gap-6">
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          ...
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($user['full_name']); ?></p>
        </div>
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          <p class="text-xs font-bold text-stone-400 uppercase mb-1">Email</p>
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($reg_email ?: '-'); ?></p>
        </div>
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          <p class="text-xs font-bold text-stone-400 uppercase mb-1">Teléfono</p>
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($reg_phone ?: '-'); ?></p>
        </div>
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          <p class="text-xs font-bold text-stone-400 uppercase mb-1">Ciudad</p>
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($reg_city ?: '-'); ?></p>
        </div>
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          <p class="text-xs font-bold text-stone-400 uppercase mb-1">Especialidad</p>
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($reg_specialties ?: '-'); ?></p>
        </div>
        <div class="bg-stone-50 p-4 rounded-lg border border-stone-100">
          <p class="text-xs font-bold text-stone-400 uppercase mb-1">Experiencia</p>
          <p class="text-stone-800 font-medium"><?php echo htmlspecialchars($reg_experience !== '' ? $reg_experience . ' años' : '-'); ?></p>
        </div>
      </div>
  ...
  <section id="proyectos" class="seccion hidden">
    ...
    <!-- Formulario de Subir Proyecto - Full Width en la parte superior -->
    <div class="bg-white p-8 rounded-xl shadow-lg border border-stone-200 mb-8">
      ...
      <form id="uploadForm" class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label class="block text-sm font-semibold text-stone-700 mb-2">Nombre del proyecto</label>
          <input name="project_name" type="text" placeholder="Ej: Mesa de comedor" required
            class="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 text-base">
        </div>
        ...
        <div class="md:col-span-2">
          ...
          <textarea name="project_description" rows="4" placeholder="Describe los detalles del proyecto..."
            class="w-full px-4 py-3 border border-stone-300 rounded-lg focus:ring-2 focus:ring-amber-500 text-base"></textarea>
        </div>
        
        <div class="md:col-span-2">
          <label class="block text-sm font-semibold text-stone-700 mb-2">Imagen del proyecto</label>
          <input name="project_image" type="file" accept="image/*"
            class="w-full text-sm text-stone-600 file:mr-4 file:py-3 file:px-6 
                   file:rounded-lg file:border-0 
                   file:text-sm file:font-semibold 
                   file:bg-amber-600 file:text-white
                   hover:file:bg-amber-700 cursor-pointer border border-stone-300 rounded-lg p-2">
        </div>
        
        <div class="md:col-span-2">
          <button type="submit" class="w-full bg-amber-600 hover:bg-amber-700 text-white py-4 rounded-lg font-bold shadow-lg text-lg transition transform hover:scale-[1.02]">
    ...
    <div>
      ...
      <?php if (empty($projects)): ?>
        <div class="bg-white p-12 rounded-xl shadow border border-stone-200 text-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-20 w-20 mx-auto text-stone-300 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
          </svg>
          <p class="text-stone-500 text-lg font-medium">Aún no has subido proyectos.</p>
          <p class="text-stone-400 text-sm mt-2">Comparte tu trabajo para que los clientes conozcan tu portafolio.</p>
        </div>
      <?php else: ?>
