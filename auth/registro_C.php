...
<body class="bg-gradient-to-br from-amber-50 to-stone-100 text-stone-800 font-sans min-h-screen flex flex-col">
  ...
  <header class="flex justify-between items-center px-8 h-20 bg-white shadow-md border-b border-stone-200">
    <div class="flex items-center gap-4">
      ...
      <img src="../assets/img/Logo de Carpintería LF.png" alt="LF Logo" class="h-16 w-auto">
    </div>
  ...
  <main class="flex-1 flex items-center justify-center p-8">
    <div class="bg-white rounded-xl shadow-lg p-8 max-w-md w-full border border-stone-200">
      <h2 class="text-3xl font-extrabold text-stone-800 mb-6 text-center">Registro de Carpintero</h2>

      <form id="formCarpintero" action="register_carpenter.php" method="POST" enctype="multipart/form-data">
