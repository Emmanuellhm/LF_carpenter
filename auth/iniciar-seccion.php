...
// Para leer parámetros como ?error=1 o ?pendiente=1
...
<body class="bg-gradient-to-br from-amber-50 to-stone-100 text-stone-800 font-sans">
  ...
  <!-- 🔥 MODAL ERROR (Credenciales inválidas) -->
  <?php if ($error): ?>
  <div id="modalError"
       class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-40 z-50">
    <div class="bg-white px-8 py-6 rounded-2xl shadow-xl max-w-sm text-center">
      <p class="text-red-600 text-xl font-bold mb-3">❌ Error de inicio de sesión</p>
      <p class="text-stone-700 mb-6">Credenciales incorrectas o rol inválido.</p>
  ...
  <header class="flex justify-between items-center px-8 h-20 bg-white shadow-md border-b border-stone-200">
    <div class="flex items-center">
      <img src="../assets/img/Logo de Carpintería LF.png" alt="LF Logo" class="h-20 w-auto">
    </div>
  ...
  <main class="px-6 md:px-20 py-16">
    ...
    <div class="flex justify-center gap-6 flex-wrap mb-12">
      <div class="card bg-white border border-stone-200 rounded-xl p-6 w-64 text-center cursor-pointer hover:shadow-lg transition"
        ...
        <img src="../assets/img/herramienta-de-martillo.png" class="w-12 mx-auto mb-3">
      ...
      <div class="card bg-white border border-stone-200 rounded-xl p-6 w-64 text-center cursor-pointer hover:shadow-lg transition"
        ...
        <img src="../assets/img/nueva-cuenta.png" class="w-12 mx-auto mb-3">
      ...
      <div class="card bg-white border border-stone-200 rounded-xl p-6 w-64 text-center cursor-pointer hover:shadow-lg transition"
        ...
        <img src="../assets/img/administrador.png" class="w-12 mx-auto mb-3">
