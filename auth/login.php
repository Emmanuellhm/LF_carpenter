...
// Priorizar user_id de la tabla users si existe (para carpinteros)
if (isset($user['user_id']) && !empty($user['user_id'])) {
    $_SESSION['user_id'] = $user['user_id'];
} else {
    $_SESSION['user_id'] = $user['id']; // Fallback a carpenter_id si no hay user_id
}
...
if ($rol === "carpenter") {
    header("Location: ../carpintero/panel_carpintero.php");
    exit;
}
