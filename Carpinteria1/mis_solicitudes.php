...
<head>
  ...
  <title>Mis Solicitudes - LF Carpintería</title>
      ...
      <main class="p-10">
        ...
        <?php if (empty($requests)): ?>
          <div class="bg-white p-12 rounded-xl shadow border border-stone-200 text-center">
            ...
            <p class="text-stone-500 text-lg mb-4">No has enviado solicitudes de proyectos aún.</p>
    ...
    function verDetalle(requestId) {
      ...
      let html = `
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
          ...
          ${req.carpenter_phone ? `<p class="text-sm text-stone-600">Teléfono: ${req.carpenter_phone}</p>` : ''}
        </div>
        ...
        <div class="mb-6">
          <p class="text-xs font-bold text-stone-400 uppercase mb-2">Descripción</p>
          <p class="text-stone-700 bg-stone-50 p-4 rounded-lg border border-stone-100">${req.description.replace(/\n/g, '<br>')}</p>
        </div>
